...
from tools.common_evaluate import evaluate_model
from tools.dnn_evaluate import dnn_evaluate_model
...
plt.title('Test ROC curve (≥ mild hepatic steatosis)', font={'family': 'Times New Roman'})
# plt.title('Test ROC curve (≥ moderate hepatic steatosis)', font={'family': 'Times New Roman'})
# plt.title('Test ROC curve (= severe hepatic steatosis)', font={'family': 'Times New Roman'})
# plt.title('Test ROC curve (≥ F1 liver fibrosis)', font={'family': 'Times New Roman'})
# plt.title('Test ROC curve (≥ F2 liver fibrosis)', font={'family': 'Times New Roman'})
# plt.title('Test ROC curve (≥ F3 liver fibrosis)', font={'family': 'Times New Roman'})
